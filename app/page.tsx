    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <nav className="flex items-center justify-between px-10 py-6 border-b border-gray-50">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-bold text-gray-900 leading-tight">Bakawan Data Analytics</span>
            <span className="text-[10px] uppercase tracking-widest text-gray-400 font-semibold">v1.0</span>
          </div>
        </div>
        <div className="flex items-center gap-6">
          <Link href="/about" className="text-sm text-gray-500 hover:text-[#05582E] transition-colors">Documentation</Link>
          <Link 
            href="/dashboard" 
            className="px-5 py-2 bg-[#05582E] text-white rounded-lg text-sm font-semibold hover:bg-[#044a27] transition-all"
          >
            Launch Dashboard
          </Link>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="max-w-3xl text-gray-500 text-lg md:text-xl mb-12 leading-relaxed">
          A standardized, pre-configured Next.js template featuring 
          modular directory structures, and a corporate UI kit.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          ...
          >
            Explore Template <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
          </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24 max-w-6xl w-full">
          <div className="group p-8 text-left bg-white border border-gray-100 rounded-3xl hover:border-[#05582E]/20 transition-all">
            ...
            <h3 className="font-bold text-xl text-gray-900 mb-3">Modular Layouts</h3>
          ...
          <div className="group p-8 text-left bg-white border border-gray-100 rounded-3xl hover:border-[#05582E]/20 transition-all">
            ...
            <h3 className="font-bold text-xl text-gray-900 mb-3">Feature Folders</h3>
            <p className="text-gray-500 leading-relaxed">
              Clean separation of concerns with dedicated components, hooks, and services per feature.
            </p>
          </div>
          ...
          <div className="group p-8 text-left bg-white border border-gray-100 rounded-3xl hover:border-[#05582E]/20 transition-all">
            ...
            <h3 className="font-bold text-xl text-gray-900 mb-3">API Wrapper</h3>
            <p className="text-gray-500 leading-relaxed">
